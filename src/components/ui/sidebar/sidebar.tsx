...
// Optional variant that returns null when no provider is found.
// Useful for components that can render without sidebar capabilities.
    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            "group/sidebar-wrapper has-data-[variant=inset]:bg-sidebar flex min-h-[100dvh] min-h-[100svh] md:min-h-screen w-full overflow-hidden",
            className
          )}
          {...props}
        >
