...
* **`read_email_pdf_attachment`**: PDF-only compatibility tool. Use this when the user is explicitly asking only about PDFs or when a prior PDF-only flow is already in progress.
