...
- `csv`
- `txt`
- calendar text attachments like `.ics`
...
- Use this when the user wants the actual contents of an attached document, spreadsheet, CSV, text file, calendar invite attachment, or PDF.
